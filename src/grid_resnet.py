...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', default='0,1,2,3,4,5,6,7', help='comma separated list of GPU(s) to use.')
    parser.add_argument('--data', default='/home/zhunsun/db/ILSVRC2012/', help='ILSVRC dataset dir')
